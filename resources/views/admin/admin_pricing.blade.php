    ...
    <div class="container d-flex flex-column px-0">
        <div class="pagetitle">
            <div class="d-flex">
                ...
                <button class="btn btn-carousel w-100 ms-auto" style="background: #7cbf00; color:azure" data-bs-toggle="modal" data-bs-target="#addfaq">Добавить прайс</button>
            </div>
            <!-- End Page Title -->
        </div>
        <!-- Modal -->
            ...
            <section id="breadcrumbs" class="breadcrumbs">
                        ...
                        <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
                          <div class="box mt-4">
                              ...
                              <ul>
                                ...
                                <div class="btn-wrap">
                                    <button class="btn btn-buy w-100" style="background-color: #1bbd36">{{$item->button}}</button>
                                    <button class="btn btn-buy w-100 mt-2" style="background-color: #7cbf00" data-bs-toggle="modal" data-bs-target="#exitfaq{{$item->id}}">Редактировать</button>
                                    <a class="mt-3 text-danger" href="/delete_pricing/{{$item->id}}">Удалить</a>
                ...
                <!-- End Sales Card -->
                <!-- Modal Exit FAq -->
                <div class="modal fade" id="exitfaq{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/edit_pricing/{{$item->id}}" method="POST">
                                    @csrf
                                    <div>
                                        ...
                                        <div class="form-floating mt-2">
                                            <input type="text" name="cost" value="{{$item->cost}}" class="form-control" id="cost" placeholder="name@example.com">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="/add_pricing" method="POST">
                    @csrf
                    <div>
                        <div class="form-floating mt-2">
                        ...
                        <div class="form-floating mt-2">
                            <input type="text" name="cost" value="" class="form-control" id="cost" placeholder="name@example.com">
                            <label for="cost">Цена</label> @if($errors->has('cost')) {{$errors->first('cost')}} @endif
                        </div>
                        <div class="form-floating mt-2">
